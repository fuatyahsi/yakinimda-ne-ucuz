"""MigrosHemen parser — discovery_pending.

Discovery notes:
    Migros Hemen fiyatları fiziksel Migros'tan farklı olabilir.

Kaynak:
    website     : https://www.migros.com.tr
    listing_url : https://www.migros.com.tr/hemen
"""
...
class MigrosHemenParser(BaseParser):
    market_id = "migros-hemen"
    alias_source = "migros-hemen"
    source_label = "migros_hemen_app"
    source_type = "api"
