"""HepsiburadaHizli parser — discovery_pending.
...
class HepsiburadaHizliParser(BaseParser):
    market_id = "hepsiburada-hizli"
    alias_source = "hepsiburada-hizli"
    source_label = "hepsiburada_hizli_app"
    source_type = "api"
