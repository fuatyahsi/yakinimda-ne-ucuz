"""YemeksepetiMarket parser — discovery_pending.

Discovery notes:
    Çoklu 3. parti market entegrasyonu var. Her chain ayrı listelenir.

Kaynak:
    website     : https://www.yemeksepeti.com
    listing_url : https://www.yemeksepeti.com/market
"""
...
class YemeksepetiMarketParser(BaseParser):
    market_id = "yemeksepeti-market"
    alias_source = "yemeksepeti-market"
    source_label = "yemeksepeti_market_app"
    source_type = "api"
