"""Cagdas parser — discovery_pending.

Discovery notes:
    Marmara bölgesel zincir. Resmi aktüel URL doğrulanmalı.

Kaynak:
    website     : https://www.cagdaslar.com.tr
    listing_url : 
"""
...
class CagdasParser(BaseParser):
    market_id = "cagdas"
    alias_source = "cagdas"
    source_label = "cagdas_katalog"
