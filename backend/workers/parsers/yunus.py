"""Yunus parser — discovery_pending.

Discovery notes:
    İstanbul odaklı bölgesel zincir.

Kaynak:
    website     : https://www.yunus.com.tr
    listing_url : https://www.yunus.com.tr/aktuel
"""
...
class YunusParser(BaseParser):
    market_id = "yunus"
    alias_source = "yunus"
    source_label = "yunus_katalog"
