"""Getir parser — discovery_pending.

Discovery notes:
    Q-commerce. Mobile app reverse engineering gerekir, HTTP API public değil. KVKK/ToS önce değerlendirilmeli.
...
class GetirParser(BaseParser):
    market_id = "getir"
    alias_source = "getir"
    source_label = "getir_app"
    source_type = "api"
    status = "discovery_pending"
    discovery_notes = (
        "Q-commerce. Mobile app reverse engineering gerekir, HTTP API public de"
        "ğil. KVKK/ToS önce değerlendirilmeli."
    )
