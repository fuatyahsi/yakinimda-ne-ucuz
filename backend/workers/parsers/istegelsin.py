"""IsteGelsin parser — discovery_pending.

Discovery notes:
    Migros bünyesi q-commerce.

Kaynak:
    website     : https://www.istegelsin.com
    listing_url : https://www.istegelsin.com
"""
...
class IsteGelsinParser(BaseParser):
    market_id = "istegelsin"
    alias_source = "istegelsin"
    source_label = "istegelsin_app"
    source_type = "api"
