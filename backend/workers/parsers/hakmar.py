"""Hakmar parser — discovery_pending.

Discovery notes:
    Marmara ağırlıklı bölgesel zincir, Cuma aktüel.

Kaynak:
    website     : https://www.hakmar.com.tr
    listing_url : https://www.hakmar.com.tr/aktuel-urunler
"""
...
class HakmarParser(BaseParser):
    market_id = "hakmar"
    alias_source = "hakmar"
    source_label = "hakmar_aktuel"
