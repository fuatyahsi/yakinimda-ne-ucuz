"""Altunbilekler parser — discovery_pending.

Discovery notes:
    Ankara merkezli bölgesel zincir.

Kaynak:
    website     : https://www.altunbilekler.com
    listing_url : https://www.altunbilekler.com/aktuel-urunler
"""
...
class AltunbileklerParser(BaseParser):
    market_id = "altunbilekler"
    alias_source = "altunbilekler"
    source_label = "altunbilekler_katalog"
