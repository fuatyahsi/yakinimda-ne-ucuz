"""Gimsa parser — discovery_pending.

Discovery notes:
    Sakarya bölgesi.

Kaynak:
    website     : https://www.gimsa.com.tr
    listing_url : https://www.gimsa.com.tr/katalog
"""
...
class GimsaParser(BaseParser):
    market_id = "gimsa"
    alias_source = "gimsa"
    source_label = "gimsa_katalog"
