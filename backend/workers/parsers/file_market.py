"""FileMarket parser — discovery_pending.

Discovery notes:
    Migros bünyesi premium segment.

Kaynak:
    website     : https://www.filemarket.com.tr
    listing_url : https://www.filemarket.com.tr/kampanyalar
"""
...
class FileMarketParser(BaseParser):
    market_id = "file"
    alias_source = "file"
    source_label = "file_kampanya"
