"""Bildirici parser — discovery_pending.

Discovery notes:
    Kocaeli/İstanbul. Resmi aktüel URL discovery gerekli.

Kaynak:
    website     : https://www.bildirici.com.tr
    listing_url : 
"""
...
class BildiriciParser(BaseParser):
    market_id = "bildirici"
    alias_source = "bildirici"
    source_label = "bildirici_aktuel"
