"""Onur parser — discovery_pending.

Discovery notes:
    İstanbul/Anadolu yakası.

Kaynak:
    website     : https://www.onurmarket.com.tr
    listing_url : https://www.onurmarket.com.tr/aktuel-urunler
"""
...
class OnurParser(BaseParser):
    market_id = "onur"
    alias_source = "onur"
    source_label = "onur_aktuel"
